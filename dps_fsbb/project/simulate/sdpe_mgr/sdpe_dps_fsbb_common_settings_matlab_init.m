...
CTRL_FSBB_IOUT_SENSITIVITY = 0.025;
...
FSBB_DEFAULT_OUTPUT_VOLTAGE = 20.0;
...
FSBB_CURRENT_LOOP_BANDWIDTH = 200.0;

% Voltage-loop crossover frequency.
FSBB_VOLTAGE_LOOP_BANDWIDTH = 20.0;
...
% Display-only IL-reference difference before changing AUTO-CV/AUTO-CC.
FSBB_AUTO_DISPLAY_HYST_PU = 0.005;

% Display-only AUTO regulation-state confirmation time in ms.
FSBB_AUTO_DISPLAY_CONFIRM_MS = 20.0;
